...
def conv_bn_elu(net, residual, num_features, is_training, is_batch_norm, layer_name):
    """ Unet_V2 conv layer
        Inputs: net - input feature map
                residual - x input to add for skip connection
...
def conv_block(net, residual, num_features, is_training, is_batch_norm, layer_name):
    """ Unet_V2 conv block
        Inputs: net - input feature map
                residual - x input to add for skip connection
                num_features - number of features in convolution block
